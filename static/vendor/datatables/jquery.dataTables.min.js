...
(function(h) {
        ...
        if (b)
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    ...
                    j = 0;
                    for (i = m.length; j < i; j++)("_all" == q[f] || h(m[j].nTh)
                        .hasClass(q[f])) && d(j, l)
                }
            }
        if (c) {
    ...
    function ea(a, b, c, d) {
        ...
        if ("dom" === c || (!c || "auto" === c) && "dom" === e.src) e._aData = Ka(a, e, d, d === k ? k : e._aData)
            .data;
        else {
            var j = e.anCells;
            if (j)
    ...
    function mb(a) {
        ...
        if (null !== j) {
            a = a.aoFooter[0];
            b = 0;
            for (c = a.length; b < c; b++) f = m[b], f.nTf = a[b].cell, f.sClass && h(f.nTf)
                .addClass(f.sClass)
        }
    }
        ...
        if (-1 !== h.inArray(!1, b)) D(a, !1);
            ...
            if (0 !== i.length) {
                ...
                .append(h("<td />", {
                    ...
                    .html(c))[0];
            t(a, "aoHeaderCallback", "header", [h(a.nTHead)
                .children("tr")[0], Ma(a), g, l, i
            ]);
            t(a, "aoFooterCallback", "footer", [h(a.nTFoot)
                .children("tr")[0],
                Ma(a), g, l, i
            ]);
            d = h(a.nTBody);
    ...
    function qb(a) {
        ...
        i.children()
            .append(a.oLanguage.sLengthMenu.replace("_MENU_",
                e[0].outerHTML));
        h("select", i)
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            p.children("thead, tfoot")
                .remove();
            s && (R = s.clone()
                .prependTo(p), Q = s.find("tr"), R = R.find("tr"));
            xa = o.clone()
                .prependTo(p);
            o = o.find("tr");
            L = xa.find("tr");
            ...
            if ("" === c) {
                t.width = "100%";
                if (V && (p.find("tbody")
                        .height() > j.offsetHeight || "scroll" == m.css("overflow-y"))) t.width = w(p.outerWidth() - b);
                f = p.outerWidth()
    ...
    function Ha(a) {
        ...
        if (d || !u && !f && !e && j == W(a) && j == l.length)
            for (n = 0; n < j; n++) i = ba(a, n), null !== i && (c[i].sWidth = w(l.eq(n)
                .width()));
        else {
            j = h(b)
                .clone()
            ...
            for (n = 0; n < i.length; n++) o = c[i[n]], l[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : "", o.sWidthOrig && f && h(l[n])
                .append(h("<div/>")
                    .css({
                        width: o.sWidthOrig,
                        margin: 0,
            ...
            if (a.aoData.length)
                for (n = 0; n < i.length; n++) u = i[n], o = c[u], h(Hb(a, u))
                    .clone(!1)
            ...
            for (n = e = 0; n < i.length; n++) k = h(l[n]), g = k.outerWidth() - k.width(), k = p.bBounding ? Math.ceil(l[n].getBoundingClientRect()
                .width) : k.outerWidth(), e += k, c[i[n]].sWidth = w(k - g);
            b.style.width = w(e);
            o.remove()
        }
        m && (b.style.width = w(m));
    ...
    function ya(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            e = 0;
            for (f = b.length; e < f; e++) g = b[e].src, h(C(a.aoData, "anCells", g))
                .removeClass(c + (2 > e ? e + 1 : 3));
            e = 0;
            for (f = d.length; e < f; e++) g = d[e].src, h(C(a.aoData, "anCells", g))
                    ...
                    var V = p.oFeatures,
                        e = function() {
                            ...
                            if (b.length === 0 || b.children()
                                .length === 0) q.addClass(s.sNoFooter);
                            else if (b.length > 0) {
                                p.nTFoot = b[0];
                ...
                if (d._details) {
                    ...
                    0 < C(g, "_details")
                        .length && (f.on("draw.dt.DT_details", function(a, b) {
                            ...
                            if (e ===
                                b)
                                for (var c, d = W(b), f = 0, h = g.length; f < h; f++) c = g[f], c._details && c._details.children("td[colspan]")
                                    .attr("colspan", d)
            ...
            var d = c[0],
                ...
                f = function(a, b) {
                    if (h.isArray(a) ||
                        ...
                        .addClass(b), h("td", c)
                        .addClass(b)
                        .html(a)[0].colSpan = W(d), e.push(c[0]))
                };
            f(a, b);
